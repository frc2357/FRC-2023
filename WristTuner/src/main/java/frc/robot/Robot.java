...
public class Robot extends TimedRobot {
  ...
  public void teleopPeriodic() {
    ...
    SmartDashboard.putNumber("Velocity", m_motor.getEncoder().getVelocity());
    SmartDashboard.putNumber("Current rotations", m_motor.getEncoder().getPosition());
    SmartDashboard.putNumber("Output", m_motor.getAppliedOutput());
  ...
  public void testPeriodic() {
    m_motor.set(deadband(controller.getLeftY(), 0.1) * -1);

    if (controller.getBButtonPressed()) {
      m_motor.getEncoder().setPosition(0);
    }

    // System.out.println("Output current: " + m_motor.getOutputCurrent());
    
    SmartDashboard.putNumber("Velocity", m_motor.getEncoder().getVelocity());
    SmartDashboard.putNumber("Current rotations", m_motor.getEncoder().getPosition());
    SmartDashboard.putNumber("Output", m_motor.getAppliedOutput());
    // System.out.println(m_motor.getInverted());
  }
