...
public class EverybotClawSubsystem extends SubsystemBase {
    private static EverybotClawSubsystem instance = null;

    public static EverybotClawSubsystem getInstance() {
        return instance;
    }
    ...
    public EverybotClawSubsystem(int clawMotorID) {
