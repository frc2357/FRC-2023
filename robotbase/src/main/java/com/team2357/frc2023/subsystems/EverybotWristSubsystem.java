...
public class EverybotWristSubsystem extends ClosedLoopSubsystem {
    private static EverybotWristSubsystem instance = null;

    public static EverybotWristSubsystem getInstance() {
        return instance;
    }
    ...
    public EverybotWristSubsystem(int motorId) {
