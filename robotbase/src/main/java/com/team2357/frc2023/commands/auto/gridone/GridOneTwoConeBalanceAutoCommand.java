...
public class GridOneTwoConeBalanceAutoCommand extends ParallelCommandGroup {
    public GridOneTwoConeBalanceAutoCommand() {
        addCommands(
                new WaitCommand(0)
                ...
                new WaitCommand(7)
                        .andThen(TrajectoryUtil.createTrajectoryPathCommand("grid1 2 cone", true))
