...
public class PPHolonomicDriveController {
   ...
   * @param rotationController2 A PID controller to respond to error in rotation
   */
  public PPHolonomicDriveController(
      PIDController xController, PIDController yController, ProfiledPIDController rotationController2) {
