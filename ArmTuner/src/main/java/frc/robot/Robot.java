...
public class Robot extends TimedRobot {
  ...
  private double armExtensionMax = 42;
  ...
  public void robotInit() {
    ...
    m_extensionMotor.setSmartCurrentLimit(60, 60);
