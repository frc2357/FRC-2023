...
public class Robot extends TimedRobot {
  ...
  public double m_rotationsPerRadian = 114.55 / (2 * Math.PI);
  public double m_horizontalRotations = 0;
  // public double m_horizontalRotations = 114.55/4;


  private double floorSetpoint = 146;
  ...
  public void teleopPeriodic() {
    ...
    if(mode) {
      ...
      m_pidController.setReference(setPoint, CANSparkMax.ControlType.kSmartMotion, 0, feedForward, ArbFFUnits.kPercentOut);
