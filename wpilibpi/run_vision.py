...
from calibration import cam0, image_cal  # bandaid for
...
if __name__ == "__main__":
    ...
    # gamepiece_NT = nt_table.getStringArrayTopic("grid").getEntry(["*", "*", "*"])
    ...
    while True:
        ...
        try:
            ...
            j["tags"] = apriltag.to_dict()
            log.debug(f"Timestamp: {j['timestamp']}")
            apriltag_NT.set(json.dumps(j, separators=(",", ":")))  # send data to networks table
