...
if __name__ == "__main__":
    ...
    CAM_INDEX = 1
    camConfig = cameraConfigs[CAM_INDEX].config
    sink = cameras[CAM_INDEX]["sink"]
    ...
    #print(f"camera {CAM_INDEX} config:" + json.dumps(camConfig.config))
    print(f"camera {CAM_INDEX} width:" + str(camConfig["width"]))
    print(f"camera {CAM_INDEX} height:" + str(camConfig["height"]))
    #return (camConfig,sink,frame,blackFrame,outputStream)

    detector,estimator = apriltag_funcs.get_apriltag_detector_and_estimator([camConfig["width"]/2,camConfig["height"]])
